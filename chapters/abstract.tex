\begin{abstract}
Ο \en{Compact LInear Collider (CLIC)} θα χρησιμοποιεί μια καινοτόμα μέθοδο επιτάχυνσης, στην οποία ενέργεια που εξάγεται από μια υψηλής έντασης δέσμη ηλεκτρονίων σχετικά χαμηλής ενέργειας (τη Δέσμη Οδηγό), χρησιμοποιείται για την επιτάχυνση μιας χαμηλότερης σε ένταση Κύριας Δέσμης σε πολύ υψηλή ενέργεια.
...
Αναπτύξαμε ένα περιβάλλον προσομοίωσης που επιτρέπει τη μοντελοποίηση αυτής της περίπτωσης.
   ...
   \begin{keywords}
   Σαρωτής Δεσμών Ηλεκτρονίων, προφίλ δέσμης, επιταχυντής \en{CLIC}, γραμμικός επιταχυντής, μη επεμβατική μέτρηση προφίλ
   \end{keywords}
