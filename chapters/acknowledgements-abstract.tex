...
Θα ήθελα να ευχαριστήσω τον καθηγητή  κ. Νικόλαο Κανταρτζή για την επίβλεψη αυτής της διπλωματικής εργασίας, τη στήριξή και βοήθειά του καθώς και τις υποδομές που επέτρεψαν την ολοκλήρωση της διπλωματικής στο Α.Π.Θ..

Επίσης, ευχαριστώ ιδιαίτερα τον \en{Dr. Adam Jeff}, επιβλέποντα ερευνητή στο \en{CERN}, για την καθοδήγησή του και την εξαιρετική συνεργασία που είχαμε τους 12 μήνες που εργαζόμουν στην Ελβετία. 
