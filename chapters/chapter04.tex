...
\begin{figure}[tph]	
	...
	\begin{subfigure}{0.47\textwidth}
		...
		{Επιρροή της αρχικής θέσης ριπής ($Y$-\en{offset}) της δέσμης ανίχνευσης στο ύψος και το λόγο της έλλειψης.}
...
\begin{figure}[tph]	
	...
	\begin{subfigure}{0.47\textwidth}
		...
		\centering
		\caption{Επιρροή της αρχικής θέσης ριπής ($Y$-\en{offset}) της δέσμης ανίχνευσης στον λόγο της έλλειψης.}
