...
\lstinputlisting[language=matlab, float, caption={\tg{Η συνάρτηση υπολογισμού των γωνιών απόκλισης της δέσμης}}]{code/EBS-variable-alanysis/staticBeamDeflection.m}
...
\lstinputlisting[language=matlab, float, caption={\tg{Το }\en{script}\tg{ υπολογισμού του κατάλληλου για τα δεδομένα μας $c_{off}$}}]{code/Calculating-optimum-coff/findOptimumCoff.m}
...
\item Εισαγωγή των δεδομένων στο \en{MATLAB}
...
\lstinputlisting[language=matlab, float, linerange={1-8, 44-62}, caption={\tg{Μέρος της συνάρτησης }\src{importField.m}}]{code/particle-path-calculation/importField.m}

\lstinputlisting[language=matlab, float, linerange={1-9,16-37, 51-60}, caption={\tg{Μέρος της συνάρτησης }\src{convertFieldDataToCell.m}}]{code/particle-path-calculation/convertFieldDataToCell.m}

\subsection{Εισαγωγή των δεδομένων στο \en{MATLAB}}


\subsection{Υπολογισμός των τροχιών της δέσμης ανίχνευσης}
\lstinputlisting[language=matlab, float, caption={\tg{Η συνάρτηση }\src{calcNextPosition.m}}]{code/particle-path-calculation/calcNextPosition.m}

\lstinputlisting[language=matlab, float, caption={\tg{Η συνάρτηση }\src{calcField.m}}]{code/particle-path-calculation/calcField.m}

\lstinputlisting[language=matlab, float, caption={\tg{Η συνάρτηση }\src{lininterp1.m}}]{code/particle-path-calculation/lininterp1.m}


Το \en{script} που εκτελεί τον υπολογισμό της τροχιάς
