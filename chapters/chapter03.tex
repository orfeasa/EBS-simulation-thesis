...
Για τον υπολογισμό του κατάλληλου συντελεστή κλιμακοποίησης $c_{off}$, δημιουργήθηκε το κατάλληλο \en{script} στο \en{MATLAB}. 



%TODO continue from here
%\selectlanguage{english}
\lstinputlisting[language=matlab, caption={Caption text}]{code/Calculate_Ideal_coff.m}
