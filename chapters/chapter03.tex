...
\lstinputlisting[language=matlab, caption={\tg{Η συνάρτηση υπολογισμού του $c_{scale}$}}]{code/Calculating-optimum-coff/calculateCscale.m}
...
\section{Δυνατότητα ανάλυσης δεσμών στο \en{MATLAB}}
