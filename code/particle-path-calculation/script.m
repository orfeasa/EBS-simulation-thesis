...
while (true)
	...
	while (not(hasReachedMonitor))
		...
		[pos_new, v_new, t_new] = calcNextPosition(...
            pos_old, v_old, t_old, Field, timeUnit, ...
            finalTime);
		...
		if (pos_new(1) >= monitorPosX)
			...
			x  = monitorPosX;			
			y  = lininterp1(pos_old(1), ...
                pos_new(1), pos_old(2), ...
                pos_new(2), monitorPosX);
			z  = lininterp1(pos_old(1), ...
                pos_new(1), pos_old(3), ...
                pos_new(3), monitorPosX);
			vx = lininterp1(pos_old(1), ...
                pos_new(1), v_old(1), ...
                v_new(1),   monitorPosX);
			vy = lininterp1(pos_old(1), ...
                pos_new(1), v_old(2), ...
                v_new(2),   monitorPosX);
			vz = lininterp1(pos_old(1), ...
                pos_new(1), v_old(3), ...
                v_new(3),   monitorPosX);
