...
% manual edit: Manually modify `main.bbl' by adding \selectlanguage{english} (2nd line) \selectlanguage{english} (last line) in order to correctly display Latin and Greek characters in the final text. 
